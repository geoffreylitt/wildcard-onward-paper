...
%DIF ADD paper.tex                Sat Aug 15 16:07:06 2020
...
\title{\DIFdelbegin \DIFdel{End-User Software }\DIFdelend \DIFaddbegin \DIFadd{Data-Driven }\DIFaddend Customization \DIFdelbegin \DIFdel{by Direct Manipulation }\DIFdelend of \DIFdelbegin \DIFdel{Tabular
Data}\DIFdelend \DIFaddbegin \DIFadd{Web Applications}\DIFaddend }
...
\DIFaddbegin \hypertarget{generic-data-interfaces}{%
\subsection{Generic data interfaces}\label{generic-data-interfaces}}

\begin{itemize}
\item
  \DIFadd{what makes a UI good for customization?
}

  \begin{itemize}
  \tightlist
  \item
    \DIFadd{generic: can show data from many apps
  }\item
    \DIFadd{neutral: doesn't prioritize a particular use case, leaves the
    imagination open
  }\item
    \DIFadd{good affordances for performing common actions
  }\end{itemize}
\item
  \DIFadd{could be others besides a table
}
