...
%DIF ADD paper.tex                Sat Aug 15 15:16:29 2020
...
scraping techniques to implement \DIFdelbegin \DIFdel{table-driven }\DIFdelend \DIFaddbegin \DIFadd{data-driven }\DIFaddend customization for existing
Web applications. In Section~\ref{sec:example}, we \DIFdelbegin \DIFdel{illustrate }\DIFdelend \DIFaddbegin \DIFadd{concretely
demonstrate }\DIFaddend the end user experience of \DIFdelbegin \DIFdel{table-driven customization through an example
scenario, }\DIFdelend using Wildcard to add features to
\DIFdelbegin \DIFdel{Hacker News}\DIFdelend \DIFaddbegin \DIFadd{a news website}\DIFaddend .

In Section~\ref{sec:architecture}, we explain the system architecture of
\DIFdelbegin \DIFdel{table-driven }\DIFdelend \DIFaddbegin \DIFadd{data-driven }\DIFaddend customization. We focus on the \emph{table adapter}
...
In Section~\DIFdelbegin \DIFdel{\ref{sec:themes}}\DIFdelend \DIFaddbegin \DIFadd{\ref{sec:visions}}\DIFaddend , we discuss some key themes from our work:

\begin{itemize}
\tightlist
\item
  \emph{Customization by direct manipulation}: We discuss further how
  \DIFdelbegin \DIFdel{table-driven }\DIFdelend \DIFaddbegin \DIFadd{data-driven }\DIFaddend customization relates to a gentle slope of customization.
...
\DIFdelbegin \DIFdel{Table-driven }\DIFdelend \DIFaddbegin \DIFadd{data-driven }\DIFaddend customization relates to existing work in many areas. Our
