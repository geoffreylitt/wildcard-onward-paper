...
%DIF ADD paper.tex                Sat Aug 15 16:08:53 2020
...
\title{\DIFdelbegin \DIFdel{End-User Software Customization by Direct Manipulation of Tabular
Data}\DIFdelend \DIFaddbegin \DIFadd{Test}\DIFaddend }
...
%% article.
\begin{abstract}
  \DIFdelbegin \DIFdel{In this paper we introduce }\emph{\DIFdel{table-driven customization}}%DIFAUXCMD
\DIFdel{, a new
  way for end users to extend software by direct manipulation without
  doing traditional programming.
We augment existing user interfaces
...
%DIFDELCMD <   %%%
\DIFdel{We illustrate the approach with Wildcard, a browser extension that
